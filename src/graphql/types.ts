...
export type CreateSubscriverMutationVariables = Exact<{
  name: Scalars['String'];
  email: Scalars['String'];
}>;


export type CreateSubscriverMutation = { __typename?: 'Mutation', createSubscriber?: { __typename?: 'Subscriber', id: string } | null };
...
export type GetLessonBySlugQueryQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', title: string, videoId: string, description?: string | null, teacher?: { __typename?: 'Teacher', bio: string, avatarURL: string, name: string } | null } | null };
...
export const CreateSubscriverDocument = gql`
    mutation CreateSubscriver($name: String!, $email: String!) {
  createSubscriber(data: {name: $name, email: $email}) {
    id
  }
}
    `;
export type CreateSubscriverMutationFn = Apollo.MutationFunction<CreateSubscriverMutation, CreateSubscriverMutationVariables>;

/**
 * __useCreateSubscriverMutation__
 *
 * To run a mutation, you first call `useCreateSubscriverMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateSubscriverMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [createSubscriverMutation, { data, loading, error }] = useCreateSubscriverMutation({
 *   variables: {
 *      name: // value for 'name'
 ...
 * });
 */
export function useCreateSubscriverMutation(baseOptions?: Apollo.MutationHookOptions<CreateSubscriverMutation, CreateSubscriverMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateSubscriverMutation, CreateSubscriverMutationVariables>(CreateSubscriverDocument, options);
      }
export type CreateSubscriverMutationHookResult = ReturnType<typeof useCreateSubscriverMutation>;
export type CreateSubscriverMutationResult = Apollo.MutationResult<CreateSubscriverMutation>;
export type CreateSubscriverMutationOptions = Apollo.BaseMutationOptions<CreateSubscriverMutation, CreateSubscriverMutationVariables>;
